    ...
    var_dump($myimg);
        if($img_size < 2097152) {
            if(in_array($img_ext, $allowed_ext) ) {
              ...
              }  if(empty($myimg && $errors)  ){

                      $insert2="INSERT INTO users( username, email, password)
                       VALUES ('$uname','$email','$pass')";
                       $exct= mysqli_query($conn , $insert2);
            ...
            } elseif(!in_array($img_ext, $allowed_ext) ){
                $errors[] = 'plz upload file png or jpg';
            } 
...
?>
        ...
        <div class="social">
            <div class="go"><i class="fab fa-google"></i><a href="login.php"> login</a> </div>
        </div>
    </form>
